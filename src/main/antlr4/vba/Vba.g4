...
valueStmt : 
	...
	| op=ADDRESSOF WS? val=valueStmt 									# vsUnary
	
	| val1=valueStmt WS? op=POW WS? val2=valueStmt						# vsBinary
	| op=MINUS WS? val=valueStmt 										# vsUnary
	| op=PLUS WS? val=valueStmt		 									# vsUnary
	| val1=valueStmt WS? op=MULT WS? val2=valueStmt 					# vsBinary
	| val1=valueStmt WS? op=DIV WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=MOD WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=PLUS WS? val2=valueStmt 					# vsBinary
	| val1=valueStmt WS? op=MINUS WS? val2=valueStmt 					# vsBinary
	
	| val1=valueStmt WS? op=AMPERSAND WS? val2=valueStmt 				# vsBinary
	
	| val1=valueStmt WS? op=LIKE WS? val2=valueStmt 					# vsBinary
	| val1=valueStmt WS? op=IS WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=GEQ WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=LEQ WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=GT WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=LT WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=NEQ WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=EQ WS? val2=valueStmt 						# vsBinary

	| op=NOT WS? val=valueStmt 											# vsUnary
	| val1=valueStmt WS? op=AND WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=OR WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=XOR WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=EQV WS? val2=valueStmt 						# vsBinary
	| val1=valueStmt WS? op=IMP WS? val2=valueStmt 						# vsBinary
;
